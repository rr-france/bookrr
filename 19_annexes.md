...
Dans la forme traditionnelle du *book sprint*  *SG*(Baker, Rachel, David Berry, Mark Brokering, Michael Dieter, Amanda French, and Barbara Rühling. 2014. On Book Sprints. Berlin: Booksprints.net. https://www.booksprints.net/en/blog/book-sprint-on-book-sprints/.
), les auteurs conçoivent la **table des matières à partir de rien** : il n’y a pas de séance de travail préparatoire. **C’est le travail collaboratif qui permet de faire émerger les contenus et leurs publics cibles**. 
...
Dans les années 2000, les *book sprints* se sont développés sur les modèles des sprints informatiques pour produire rapidement de la documentation sur les logiciels libres. Adam Hyde, fondateur de *FlossManuals* [https://fr.wikipedia.org/wiki/FLOSS_Manuals] a été pionnier dans le domaine. 
